...
func Build(repoRoot, workdir, model string, maxSteps int) string {
...
- Never invent tool results or claim changes you did not make.`, repoRoot, workdir, model, maxSteps)
}
